...
#include "layer/strategy/common/colordependentpucktargetfetchertest.h"
...
CPPUNIT_TEST_SUITE_REGISTRATION(RoboHockey::Layer::Strategy::Common::ColorDependentPuckTargetFetcherTest);
