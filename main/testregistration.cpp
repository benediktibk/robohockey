...
#include "layer/strategy/drivepuckstatemachine/checkpuckcolorstatetest.h"
...
CPPUNIT_TEST_SUITE_REGISTRATION(RoboHockey::Layer::Strategy::DrivePuckStateMachine::CheckPuckColorStateTest);
