...
DrivePuckToEnemyThirdState::DrivePuckToEnemyThirdState(Robot &robot, Field &field, Referee &referee, RoboHockey::Common::Logger &logger, ColorDependentPuckTargetFetcher &puckTargetFetcher) :
