...
namespace DrivePuckStateMachine
{
			...
			public CPPUNIT_NS::TestFixture
	{
		...
		CPPUNIT_TEST(nextState_emptyTargetListAndTargetNotReachedAndReachedTargetAfterUpdate_nextStateIsFindPuckState);
	...
	private:
		...
		void nextState_emptyTargetListAndTargetNotReachedAndReachedTargetAfterUpdate_nextStateIsFindPuckState();
