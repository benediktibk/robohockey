...
namespace View
{
	...
	public:
        ...
        void setData(const std::vector<Autonomous::FieldObject> &fieldObjects, bool stuckAtObstacle, bool reachedTarget, const Common::Point &currentPosition, const double currentOrientation);
