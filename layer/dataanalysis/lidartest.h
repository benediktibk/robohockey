...
namespace DataAnalysis
{
			...
			public CPPUNIT_NS::TestFixture
	{
		...
		CPPUNIT_TEST(canBeSeen_atLeftEdgeOfViewArea_false);
		CPPUNIT_TEST(canBeSeen_atRightEdgeOfViewArea_false);
		CPPUNIT_TEST(canBeSeen_outsideOfViewArea_false);
		CPPUNIT_TEST(canBeSeen_totallyCoveredByOtherObject_false);
		CPPUNIT_TEST(canBeSeen_fromRightSideCoveredByOtherObject_false);
		CPPUNIT_TEST(canBeSeen_fromLeftSideCoveredByOtherObject_false);
		CPPUNIT_TEST(canBeSeen_partlyCoveredFromBothSides_false);
		...
		CPPUNIT_TEST(canBeSeen_objectDirectBehindOtherObstacle_false);
		...
		CPPUNIT_TEST(canBeSeen_objectPartlyVisibleAtLeftEdgeOfViewArea_false);
		CPPUNIT_TEST(canBeSeen_objectPartlyVisibleAtRightEdgeOfViewArea_false);
		CPPUNIT_TEST(canBeSeen_onePuckBehindAnotherOne_false);
	...
	private:
		...
		void canBeSeen_atLeftEdgeOfViewArea_false();
		void canBeSeen_atRightEdgeOfViewArea_false();
		void canBeSeen_outsideOfViewArea_false();
		void canBeSeen_totallyCoveredByOtherObject_false();
		void canBeSeen_fromRightSideCoveredByOtherObject_false();
		void canBeSeen_fromLeftSideCoveredByOtherObject_false();
		void canBeSeen_partlyCoveredFromBothSides_false();
		...
		void canBeSeen_objectDirectBehindOtherObstacle_false();
		...
		void canBeSeen_objectPartlyVisibleAtLeftEdgeOfViewArea_false();
		void canBeSeen_objectPartlyVisibleAtRightEdgeOfViewArea_false();
		void canBeSeen_onePuckBehindAnotherOne_false();
