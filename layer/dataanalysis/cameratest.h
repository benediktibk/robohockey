...
namespace DataAnalysis
{
			...
			public CPPUNIT_NS::TestFixture
	{
		...
		CPPUNIT_TEST(getProbabilityForCollectedYellowPuck_yellowPuckCollectedLeftSecondVersion_resultIsOver80Percent);
	...
	private:
		...
		void getProbabilityForCollectedYellowPuck_yellowPuckCollectedLeftSecondVersion_resultIsOver80Percent();
